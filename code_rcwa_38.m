...
teta0 = 36.49986177013811	;      % incident angle in degree
...
h   = 1474.1021341029605/1000;       % grating pillar height, um
w_b = D*0.5334726980720896;       % pillar bottom width, um
...
writetable(sweep_result, '/fs/ess/PAS1730/Johnny/GratingOptimization/GratingOpt/Results/38/DE_vs_wavelength.csv');
...
% =========================================================
rcwa_result = table(teta0, 1474.1021341029605, 0.5334726980720896, max(DE_m1), mean(DE_m1), ...
    'VariableNames', {'aoi', 'tp', 'dc', 'DE_m1_peak', 'DE_m1_avg'});
writetable(rcwa_result, '/fs/ess/PAS1730/Johnny/GratingOptimization/GratingOpt/Results/38/RCWA_result.csv');