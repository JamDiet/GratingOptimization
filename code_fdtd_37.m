...
myLaser = Laser(1950, 70, 4500, 0.45, 37.498352627296185, 's');
...
% ---grating target---
duty_cycle = 1-0.5325825466654285;           % [#] duty cycle of the groove at the bottom
...
pillar_depth = 1342.7310212982463;           % [nm] pillar depth of the grating
...
writetable(fdtd_result, '/fs/ess/PAS1730/Johnny/GratingOptimization/GratingOpt/Results/37/FDTD_result.csv');