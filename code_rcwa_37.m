...
teta0 = 37.498352627296185	;      % incident angle in degree
...
h   = 1342.7310212982463/1000;       % grating pillar height, um
w_b = D*0.5325825466654285;       % pillar bottom width, um
...
writetable(sweep_result, '/fs/ess/PAS1730/Johnny/GratingOptimization/GratingOpt/Results/37/DE_vs_wavelength.csv');
...
% =========================================================
rcwa_result = table(teta0, 1342.7310212982463, 0.5325825466654285, max(DE_m1), mean(DE_m1), ...
    'VariableNames', {'aoi', 'tp', 'dc', 'DE_m1_peak', 'DE_m1_avg'});
writetable(rcwa_result, '/fs/ess/PAS1730/Johnny/GratingOptimization/GratingOpt/Results/37/RCWA_result.csv');